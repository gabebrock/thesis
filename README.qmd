...
1. Get socioeconomic data "data-prep/census-gis" `get-census.R`
  - "data-prep/census-gis" `get-census.R`
    - Census data using tidycensus() at the census tract level for 2009-2024, including:
      ...
      - Median income
      - Unemployment rate
  - "data-prep/census-gis" `get-bls.R`
    - BLS data, using blscrapeR() including:
      - Median income
      - Unemployment rate
...
## Crime Data
Prepare crime data at the census tract- and precinct-level for 2009-2024
