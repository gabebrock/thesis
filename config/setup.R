...
# save sqfdata to rds for faster loading in future
if (!file.exists(".data/sqf_hist.rds")) {
  saveRDS(sqf_hist, "data/sqf_hist.rds")
} else {
  message("rds file for sqf-historic data already exists.")
}
...
# complaint history
complaint_hist <- read_csv("data/nypd-crime/NYPD_Complaint_Data_Historic.csv", 
...
# save complaint data to rds for faster loading in future
if (!file.exists(".data/complaint_hist.rds")) {
  saveRDS(complaint_hist, "data/complaint_hist.rds")
} else {
  message("rds file for complaints historic data already exists.")
}

# shooting history
shooting_hist <- read_csv("data/nypd-crime/NYPD_Shootings_Data__Historic.csv", 
...
# save shooting data to rds for faster loading in future
if (!file.exists(".data/shooting_hist.rds")) {
  saveRDS(shooting_hist, "data/shooting_hist.rds")
} else {
  message("rds file for shootings historic data already exists.")
}
...
rm("required_packages", "installed_packages", "pkg", "sqf_files", "read_sqf")
