...
### Precinct 2020 nyc-census Data

```{r load nypd precinct 2020 nyc-census data}

nypdnyc_census2020 <- read_csv("r-data/nyc-census/nyc_precinct_2020pop.csv")

# format `Precinct` to match variable name in sqf dfs
nypdnyc_census2020$precinct <- sprintf("%03d", as.integer(nypdnyc_census2020$precinct))

# nyc-census (only one race totals and total 2+ races)
nypdnyc_census2020Races <- nypdnyc_census2020 %>%
...
nypdnyc_census2020Black <- nypdnyc_census2020 %>%
